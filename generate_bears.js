...
//        BODY_YELLOWWINGS: 131
    ...
    skin: {
        BEAR_SKIN_BLUE: 1068,
        BEAR_SKIN_BROWN: 1668,
        BEAR_SKIN_COW: 768,
        BEAR_SKIN_DEEPSEA: 1068,
        BEAR_SKIN_DIAMOND: 139,
        BEAR_SKIN_GALAXY: 336,
        BEAR_SKIN_GOLD: 209,
        BEAR_SKIN_GRADATION: 609,
        BEAR_SKIN_LEOPARD: 595,
        BEAR_SKIN_MUTANT: 590,
        BEAR_SKIN_ORANGE: 441,
        BEAR_SKIN_PINK: 436,
        BEAR_SKIN_POLKADOT: 389,
        BEAR_SKIN_RAINBOW: 465,
        BEAR_SKIN_STONE: 553,
        BEAR_SKIN_ZEBRA: 665
    },
    head: {
...
const merge = async (i,toMerge,metadata) => {
    return new Promise((resolve, reject) =>{
        ...
        .then(b64 => {
          ...
          const token = `public/bears/token_${ i + 1 }`
